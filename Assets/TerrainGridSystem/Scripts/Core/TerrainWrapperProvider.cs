...
namespace TGS
{
	public static class TerrainWrapperProvider
	{
		...
		public static ITerrainWrapper GetTerrainWrapper(GameObject terrainObject, string prefix, LayerMask layerMask, bool searchGlobal, int heightmapWidth, int heightmapHeight) {
